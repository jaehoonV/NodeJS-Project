...
-- / POST
SELECT D.CHAT_ROOM_NAME, D.MASTER_SEQ, CONCAT(LEFT(D.MEMBER_NM, 25), IF(CHAR_LENGTH(D.MEMBER_NM) > 25, '...', '')) AS MEMBER_NM, CONCAT(LEFT(E.CONTENTS, 25), IF(CHAR_LENGTH(E.CONTENTS) > 25, '...', '')) AS CONTENTS, D.USER_CNT,
